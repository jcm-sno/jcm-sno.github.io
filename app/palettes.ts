...
export const paletteOptions = [
  ...
  {
    id: "periwinkle-sunrise",
    name: "Periwinkle Sunrise",
    status: "Alternative 07",
    note: "Florida Sunrise's sand, tangerine, palm green, and deep teal, softened with Pressed Garden's periwinkle blue.",
    colors: [
      { role: "White", hex: "#FFFDF8" },
      { role: "Paper", hex: "#F7EACF" },
      { role: "Warm", hex: "#F2A65A" },
